...
public class Topic3 extends YouTubeBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        onInitializedListener = new YouTubePlayer.OnInitializedListener() {
            ...
            public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean b) {
                youTubePlayer.loadVideo("NvrpuBAMddw");
            }
        ...
        questionList3 = dbHelper3.getAllQuestions3();
        //assign int Total to the total number of question
        Total = questionList3.size();
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(option1.isChecked()||option2.isChecked()||option3.isChecked()||option4.isChecked()){
                    ...
                    Toast.makeText(Topic3.this,"You have to choose one answer",Toast.LENGTH_LONG);}
            }});
    ...
    private void finishQuiz(){
        //create a new intent
        Intent intent1 = new Intent(Topic3.this, Result.class);
